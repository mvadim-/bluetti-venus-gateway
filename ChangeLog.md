...
- Added BLUETTI `PACK_MAIN_INFO (6000)` aggregate pack decoding for SOC/SOH, voltage, current,
  temperature, and pack count
- Decoded EP760 battery temperature from `PACK_MAIN_INFO` data offset 14 as `uint16_be - 40`
...
- Kept `PACK_ITEM_INFO (6100)` out of the normalized battery temperature path
